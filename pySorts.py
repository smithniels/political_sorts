...
list1 = [1, 2, 3, 4, 6, 5, 20, 30, 40, 50, 400,
         2, 5, 1, 2, 50, 520, 124, 512, 5134, 10000]
...
other elements in the list past that point.
...
def republicanSort(arr):
    ...
    print("The highest number in: "+str(arr)+"\n is... " +
          str(max)+"! Do you have a problem with that?")


stal = [10, 22, 40, 2, 5, 42]
hitlerSort(stal)
